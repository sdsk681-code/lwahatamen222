      ...
      <div style="padding:14px 22px 8px;display:flex;gap:20px;align-items:flex-start;">
        ...
        <div style="flex:1;">
          ...
          <table style="width:100%;border-collapse:collapse;border:1px solid #D1D5DB;border-top:none;">
            ...
            ${bankName ? `<tr style="background:#F8FAFC;"><td style="background:#F8FAFC;color:#334155;font-size:10px;font-weight:700;border:1px solid #D1D5DB;padding:5px 8px;">البنك</td><td style="font-size:10px;font-weight:700;border:1px solid #D1D5DB;padding:5px 8px;">${escapeHtml(bankName)}${bankCountry ? ` (${escapeHtml(bankCountry)})` : ""}</td></tr>` : ""}
